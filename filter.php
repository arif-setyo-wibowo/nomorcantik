        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-9 col-md-8">
                <div class="row pb-3">
                    ...
                    <div class="col-md-4 col-sm-6 pb-1 bg-light mt-1">
    ...
    <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                ...
                <p class="mb-0"><i class="fa fa-phone-alt text-primary mr-3"></i><a href="https://api.whatsapp.com/send?phone=6288210001000&amp;text=www.nomorcantik.com"><img src="https://lh3.googleusercontent.com/-N23V4qsFKs8/WMV9mGK5x5I/AAAAAAAAAPQ/BcC6qzLzJtcqKUWAX5TXX8KxuwDX5JXAgCLcB/h90/Button%2BChat%2Bvia%2BWhatsapp.png" style=" max-width: 20%;"></a></p>
            </div>
        </div>
